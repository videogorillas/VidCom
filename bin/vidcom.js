...
const path0 = path.parse(path.resolve(process.cwd(), argv._[0]));
const path1 = path.parse(path.resolve(process.cwd(), argv._[1]));
...
if (argv._.length > 2) {
    const srtPath = path.parse(path.resolve(process.cwd(), argv._[2]));
